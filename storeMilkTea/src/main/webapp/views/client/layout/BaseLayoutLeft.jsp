...
<spring:url value="/client/assets/css/font-awesome.min.css" var="fontCss" />
...
<spring:url value="/client/assets/js/vendor/jquery-1.12.0.min.js"
	var="jqueyMinJs" />
<spring:url value="/client/assets/js/bootstrap.min.js" var="bootstrapMinJs" />
<spring:url value="/client/assets/js/owl.carousel.min.js"
	var="owlcarouselminJs" />
<spring:url value="/client/assets/js/jquery.meanmenu.js" var="jquerymeanmenuJs" />
<spring:url value="/client/assets/js/jquery-ui.min.js" var="jqueryuiminJs" />
<spring:url value="/client/assets/lib/js/jquery.nivo.slider.pack.js"
	var="jquerynivosliderpackJs" />
<spring:url value="/client/assets/lib/js/nivo-active.js" var="nivoactiveJs" />
<spring:url value="/client/assets/js/wow.min.js" var="wowminJs" />
<spring:url value="/client/assets/js/plugins.js" var="pluginsJs" />
<spring:url value="/client/assets/js/main.js" var="mainJs" />
