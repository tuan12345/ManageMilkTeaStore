...
<spring:url value="/assets/img/banner/banner-tratraicaytuoi.png" var="bannerTraiCay" />
...
<header class="header-pos sticky-top">
										...
										<ul>
												...
												<div class="mega-menu">
													...
													<div class="mega-right">
														<span class="mega-menu-img">
															<a href="shop.html"><img alt="" src="${bannerTraiCay }"></a>
														</span>
													</div>
												</div>										
											</li>
											<li><a href="shop.html">cloth</a>
												<div class="mega-menu mega-menu-2">											
													...
													<span class="mega-menu-img">
														<a href="shop.html"><img alt="" src="${tratraicaytuoi }"></a>
													</span>
												</div>											
											</li>
											<li><a href="#">pages</a>
		...
		<div class="slider-container">
			...
			<div id="mainSlider" class="nivoSlider slider-image">
				<img src="${s1 }" alt="main slider" title="#htmlcaption1"/>
				<img src="${s2 }" alt="main slider" title="#htmlcaption2"/>
				<img src="${s3 }" alt="main slider" title="#htmlcaption2"/>
